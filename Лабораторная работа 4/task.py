...
class human:
    ...
    def __init__(self, surname, name, age=None):
        ...
        Примеры:
        >>> human1 = human("Sasha", "pupupu", 19)    # Инициализация объекта класса
        """
        ...
        if not (isinstance(age, int)):
            raise TypeError("Возраст может быть только целочисленным")
        ...
        if age > 150:
            raise ValueError("Люди столько не живут")
...
class student(human):
    ...
    def __init__(self, surname, name=None, age=None, number_of_debts=0):
        ...
        Примеры:
        >>> student1 = student("Sasha", "pupupu", 19, 10)    # Инициализация объекта класса
        """
...
class prepod(human):
    ...
    def __init__(self, surname, name=None, age=None, number_of_student_expelled=0):
        ...
        if not (isinstance(number_of_student_expelled, int)):
            raise TypeError(
                "Количество отчисленных стедунтов может быть только целочисленным"
            )

        # Если введенное значение отрицательно, выдется ошибка значения
        if number_of_student_expelled < 0:
            raise ValueError(
                "Количество отчисленных студентов не может быть отрицательным"
            )
        ...
        def __str__(self):
            ...
            print(
                super.__str__()
                + f", Количество отчисленных студентов: {number_of_student_expelled}"
            )
